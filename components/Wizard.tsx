            ...
            <div className="flex flex-wrap gap-3">
              {THEME_CHIPS.map(chip => (
                <button
                  ...
                  className={`px-5 py-3 rounded-2xl text-sm font-bold border-b-4 transition-all transform active:scale-95 active:border-b-0 active:translate-y-1 ${
                    data.theme === chip
             ...
             <div className="grid grid-cols-2 gap-3">
               {ART_STYLES.map(style => (
                 <button
                   ...
                   className={`group relative flex flex-col items-center justify-center p-4 rounded-[2rem] transition-all duration-300 border-2 ${
                ...
                <div className="grid grid-cols-1 gap-3">
                    {[
                        ...
                        <button 
                            ...
                            className={`relative p-4 rounded-[2rem] flex items-center gap-4 transition-all border-2 text-left active:scale-[0.98] ${
                                data.narrativeStyle === mode.id 
